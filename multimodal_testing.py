...
def main():
    ...
    bert_class_report = classification_report(df_test[bert_args.get('label_field')], bert_predictions, output_dict=True)
    ...
    bert_resnet_predictions = bert_resnet_classifier.predict(df_test.copy(), bert_resnet_args)
    bert_resnet_class_report = classification_report(df_test[bert_resnet_args.get('label_field')], bert_resnet_predictions, output_dict=True)
    ...
    albef_class_report = classification_report(df_test[albef_args.get('label_field')], albef_predictions, output_dict=True)
